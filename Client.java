        ...
        try
        {
            ...
            while (true) {
                ...
                if(aux.matches("[-+]?([0-9]*\\.[0-9]+|[0-9]+)")){
                    ...
                    //Checagem do Operando para o server A
                    if (opera.equals("+") | opera.equals("-") | opera.equals("/") | opera.equals("*")) {
                        ...
                        if(aux.matches("[-+]?([0-9]*\\.[0-9]+|[0-9]+)")) {
                            ...
                            System.out.println("Padrao incorreto, esperando o 'Operador2' do tipo numero, recebido "+"'"+ aux+"'");
                        }
                    //Checagem do Operando para o server B
                        ...
                        System.out.println("Padrao incorreto esperando o 'Operando', recebido "+"'"+opera+"'");
                    }
                }else{
                    System.out.println("Padrao incorreto, esperando o 'Operador1' do tipo número, recebido "+"'"+aux+"'");
                }
            }
        }catch(Exception e){
            e.printStackTrace();
